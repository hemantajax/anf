...
export const INFRA_DETAILS: InfraDetail[] = [
...

  {
    ...
    utilization: [
      ...
      "  Quick Loop (~0.4 km, 4-6 min) — Zone A + B via internal roads",
      "  Full Perimeter (~0.85 km, 8-10 min) — entire boundary, coconut avenues",
      "  Grand Tour (~1.0 km, 10-15 min) — figure-8 through all 4 zones, rides between C/D on N-S road",
